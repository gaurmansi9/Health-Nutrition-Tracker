...
Before running, download the USDA FoodData Central CSV export and place these two files in a FoodData_Central/ folder in the project root:
...
Usage
Open Tracker.ipynb in Jupyter.
Run all cells in order. The first run will:
...
When main() runs, follow the on-screen prompts to:
